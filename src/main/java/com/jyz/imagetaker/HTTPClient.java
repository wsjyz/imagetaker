...
public class HTTPClient {
    ...
    public UrlEncodedFormEntity packageParams(){
        ...
        if(params.size() > 0){
            for(String key:params.keySet()){
                ...
                String paramsValues = "";
                if(isPrimitiveType(paramsValueObj.getClass()) || paramsValueObj instanceof String){
    ...
    public static boolean isPrimitiveType(Class clz) {
        ...
        try {
            if(clz.isPrimitive()){
                ...
                result =  ((Class) clz.getField("TYPE").get(null)).isPrimitive();
        } catch (Exception e) {
            result = false;
        }
        return result;
    ...
    public String request(){
        ...
        System.out.println("request uri:"+getFsUrl());
        HttpPost httpPost = new HttpPost(getFsUrl());
